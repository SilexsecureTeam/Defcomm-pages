    ...
    <ul className="hidden lg:flex items-center gap-8">
      {[
        ...
        <Link key={idx} to={item.route}>
          <li className="text-white text-sm font-medium hover:text-[#C6FC2B] transition">
            {item.label}
          </li>
        </Link>
      ))}
...
const LiveFire = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#111] to-[#222] flex flex-col">
      <LiveFireHeader />
      <main className="flex flex-col items-center justify-center flex-1 t-28 pb-16 px-4">
        <h1 className="text-3xl md:text-5xl font-semibold text-center mb-8 text-[#AC7C2E]">
          <span className="opacity-0">dfcg</span>

      ...
      <div className=" py-10 bg-[#E8EEE1]">
        <div className=" max-w-peak mx-auto p-4 ">
          ...
          >
            ...
            >
              At Defcomm, we engineer military-grade encrypted devices and
              secure communication platforms for defense, government, and
              high-security enterprises. We’re seeking an Operating System
              Engineer to design, optimize, and secure our custom OS for maximum
          ...
          >
            ...
            <motion.p
              ...
              className="text-[#3D3D3D] text-lg leading-relaxed"
            >
              You’ll be responsible for developing and maintaining Defcomm’s
              secure operating systems, ensuring that every layer from kernel to
              user interface meets the highest standards of cybersecurity and
              reliability.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-[#3D3D3D] text-lg">
              {[
                "Design, implement, and maintain custom secure operating systems.",
                "Optimize OS performance for speed, stability, and power efficiency.",
                "Integrate encryption protocols (AES-256, RSA, ECC) and biometric authentication.",
                "Develop and enforce secure bootloaders, sandboxing, and threat isolation mechanisms.",
                "Work closely with hardware teams for OS-device integration.",
                "Conduct vulnerability assessments and patch critical security issue",
              ].map((item, index) => (
                <motion.li
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
      ...
      <div className="bg-white py-14">
        <div className="max-w-peak mx-auto p-4">
          ...
          >
            ...
            <ul className="space-y-3 text-[#3D3D3D] text-lg">
              {[
                "Strong experience in OS development (Linux, Android, or embedded systems).",
                "Proficiency in C, C++, and shell scripting.",
                "Deep understanding of kernel architecture, device drivers, and system security.",
                "Experience implementing encryption and authentication systems.",
                "Familiarity with air-gapped systems and secure coding practices.",
              ].map((item, index) => (
                <motion.li
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <ul className="space-y-3 text-[#3D3D3D] text-lg">
              {[
                "Work on cutting-edge OS technology built for defense and high-security environments.",
                "Collaborate with world-class cybersecurity engineers and hardware specialists.",
                "Competitive salary, benefits, and career advancement opportunities.",
                "Be part of a mission to protect communications and digital identities worldwide.",
              ].map((item, index) => (
                <motion.li
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
        ...
        <div className="max-w-peak mx-auto pt-12">
          <div className="relative flex flex-col justify-start pt-8 items-start px-8 md:px-12 text-white lg:ml-[0px] h-fit pb-10 lg:h-[360px] space-y-2">
            ...
            >
              Operating
              <br />
              <span className="text-[#C6FC2B]">System Engineer.</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}

...
const SecuritySection = () => {
  return (
    <section className="bg-gradient-to-br from-oliveLight to-black text-white px-6 py-16 lg:flex lg:items-center lg:justify-between lg:gap-16">
      {/* Left Section */}
      <motion.div
      ...
      >
        ...
        <p className="text-gray-300 mb-6">
          Built with enterprise-grade security from the ground up. Our platform
          meets the highest industry standards and regulatory requirements,
          giving you peace of mind in an uncertain digital landscape.
        </p>

...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start justify-between gap-8 mb-12">
        <div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="text-[#EEEEEE] leading-loose max-w-sm text-[18px]">
          <p>

...
function HomeService() {
  ...
  return (
    <>
      <div className="relative pt-[80px] bg_op">
        {/* Darkening Overlay */}
        <motion.div
        ...
        >
          ...
          <div className="relative flex flex-col justify-center items-start px-8 md:px-12 text-[#D9D9E9] lg:ml-[0px] h-fit pb-10 lg:h-[550px] space-y-5">

            <h2 className="text-[35px] font-semibold md:max-w-[40%] leading-[1.4]">
              Mission-Critical Communication, <span className="text-[#C6FC2B]">Reinvented</span>
            </h2>
            <p className="text-[#D1D5DB] md:max-w-[45%]">From encrypted messaging to secure operating systems and real-time defense support tools, Defcomm delivers advanced communication infrastructure tailored for defense and government operations.</p>
            <div className="flex flex-col md:flex-row justify-center gap-x-7 gap-y-3">
